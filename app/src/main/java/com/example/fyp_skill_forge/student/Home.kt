package com.example.fyp_skill_forge.student
...
import com.example.fyp_skill_forge.auth.welcome_screen.Welcome_screen
import com.example.fyp_skill_forge.databinding.ActivityHomeBinding
import com.example.fyp_skill_forge.student.fragments.CourseFragment
import com.example.fyp_skill_forge.student.fragments.HomeFragment
import com.example.fyp_skill_forge.student.sidebar.AboutUs
import com.example.fyp_skill_forge.student.sidebar.CreateNewPassword
import com.example.fyp_skill_forge.student.sidebar.DashboardUserActivity
import com.example.fyp_skill_forge.student.sidebar.Feedback
import com.example.fyp_skill_forge.student.sidebar.PrivacyPolicy
import com.example.fyp_skill_forge.student.utlis.UserSharedPref
                ...
                R.id.delete_account -> {
                    ...
                    user?.delete()?.addOnCompleteListener {
                        if (it.isSuccessful){
                            ...
                            val i = Intent(this, Welcome_screen::class.java)
                            startActivity(i)
                            finish()
                        } else {
