package com.example.fyp_skill_forge.student.utlis

import com.example.fyp_skill_forge.R
import com.example.fyp_skill_forge.student.model.ContinueCourse
import com.example.fyp_skill_forge.student.model.RVModel
import com.example.fyp_skill_forge.student.model.WeProvided
...
object Constant {
    ...
    fun getData() : ArrayList<RVModel> {
        return arrayListOf(
            (RVModel(R.drawable.img_3, "Web Development")),
            (RVModel(R.drawable.python, "Python")),
            (RVModel(R.drawable.img_1, "Artificial Intelligence")),
            (RVModel(R.drawable.digital, "Digital Marketing")),
            (RVModel(R.drawable.img_2, "App Development")),
    ...
    fun getDataContinueCourses(): ArrayList<ContinueCourse> {
        return arrayListOf(
            ContinueCourse(0, R.drawable.img_3, "Web Developement", "Jamal The Expert", 4.5, 60),
            ContinueCourse(1, R.drawable.python, "Python", "Mudassar the pythonist", 4.2, 30),
            ContinueCourse(1, R.drawable.img_2, "App Development", "Muhammad Jamil", 3.1, 100)
        )
    }
    ...
    fun getDataWeProvided(): ArrayList<WeProvided> {
        return arrayListOf(
            ...
            WeProvided(1, R.drawable.learning1, "Quizzes")
