package com.example.fyp_skill_forge.auth.welcome_screen
...
import com.example.fyp_skill_forge.databinding.ActivityWelcomScreenBinding

class Welcome_screen : AppCompatActivity() {
    private lateinit var binding: ActivityWelcomScreenBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityWelcomScreenBinding.inflate(layoutInflater)
